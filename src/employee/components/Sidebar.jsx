        ...
        <>
            ...
            <div className=' h-[calc(100vh-3.56rem)]  border-r-gray-950 p-3'>
                <ul className='font-[heading2] tracking-wide '>
                    ...
                    <li><Link to={"/emp_dashboard"} className='flex gap-2 items-center p-2  hover:bg-gray-200 ease-in duration-300 rounded '><img src={announcement} className='w-5 h-5' /><p>Announcements</p></Link></li>
                    <li><Link to={"/emp_dashboard"} className='flex gap-2 items-center p-2  hover:bg-gray-200 ease-in duration-300 rounded '><img src={profile} className='w-5 h-5' /><p>Profile</p></Link></li>
                    <li><Link to={"/emp_dashboard"} className='flex gap-2 items-center p-2 hover:bg-gray-200 ease-in duration-300 rounded '><img src={setting} className='w-5 h-5' /><p>Settings</p></Link></li>
                </ul>
            </div>
