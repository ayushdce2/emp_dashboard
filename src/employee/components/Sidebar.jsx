        ...
        <>
            ...
            <div className=' h-[calc(100vh-3.56rem)]  border-r-gray-950 p-3'>
                <ul className='font-[heading2] tracking-wide '>
                    <li><Link to={"/emp_dashboard"} className={`flex gap-2 items-center p-2 mb-1  hover:bg-gray-200 ease-in duration-300 rounded ${pathname=="/" && "bg-gray-400"} `}><img src={dashboard} className='w-5 h-5' /><p>Dashboard</p></Link></li>
                    <li><Link to={"/emp_dashboard/leave"} className={`flex gap-2 items-center p-2  hover:bg-gray-200 ease-in duration-300 rounded ${pathname=="/leave" && "bg-gray-400"  } `}><img src={leave} className='w-5 h-5' /><p>Leave</p></Link></li>
